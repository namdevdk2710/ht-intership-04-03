        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link has-dropdown"><i class="fas fa-th-large"></i> <span>Phân Loại</span></a>
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="#">Danh Sách</a></li>
                            <li><a class="nav-link beep beep-sidebar" href="#">Thêm </a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link has-dropdown"><i class="fas fa-birthday-cake"></i> <span>Sản Phẩm</span></a>
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="#">Danh Sách </a></li>
                            <li><a class="nav-link" href="#">Thêm </a></li>
                        </ul>
                    ...
                    <li class="menu-header">Quản Lý Đơn Hàng</li>
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link has-dropdown"><i class="fas fa-ellipsis-h"></i> <span>Đơn Hàng Đợi Xử Lý</span></a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link has-dropdown"><i class="fas fa-bicycle"></i> <span>Đơn Hàng Đang Vận Chuyển</span></a>
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="#">Danh Sách </a></li>
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link has-dropdown"><i class="fas fa-grin-wink"></i> <span>Đơn Hàng Hoàn Thành</span></a>
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="#">Danh Sách</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link has-dropdown"><i class="fas fa-exclamation"></i> <span>Đơn Hàng Lỗi</span></a>
                        <ul class="dropdown-menu">
                            <li><a href="#">Danh Sách</a></li>
                        </ul>
                    </li>
                ...
                <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
                    <a href="#" class="btn btn-primary btn-lg btn-block btn-icon-split">
                        <i class="fas fa-rocket"></i> Tài Liệu Hướng Dẫn
                    </a>
                </div>
            </aside>
        </div>
